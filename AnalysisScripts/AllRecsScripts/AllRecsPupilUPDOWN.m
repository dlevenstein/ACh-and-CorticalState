...
%%
UPDOWNpupil = bz_CollapseStruct(UPDOWNPupilAll);
...
%%
pupcycleUPDOWN.ALL = bz_CollapseStruct(UPDOWNpupil.pupcycleUPDOWN,3);
pupcycleUPDOWN.bins = UPDOWNpupil.pupcycleUPDOWN.bincenters;

pupphaseUD.ALL = bz_CollapseStruct(UPDOWNpupil.pupphaseUD,1,'justcat',true);
pupphaseUD.freqs = UPDOWNpupil.pupphaseUD.freqs;

islowhist.ALL = bz_CollapseStruct(UPDOWNpupil.islowhist,3);
islowhist.phasebins = UPDOWNpupil.islowhist.phasebins;
islowhist.ampbins = UPDOWNpupil.islowhist.ampbins;

pupbyislow.ALL = bz_CollapseStruct(UPDOWNpupil.pupbyislow,3);
pupbyislow.phasebins = UPDOWNpupil.pupbyislow.phasebins;
pupbyislow.ampbins = UPDOWNpupil.pupbyislow.ampbins;
