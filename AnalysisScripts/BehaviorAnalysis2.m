...
[pupilphaseEMG.meanZ,pupilphaseEMG.N,pupilphaseEMG.Xbins,...
    pupilphaseEMG.Ybins] = ConditionalHist3( EMGwhisk.pupphase,...
    log10(EMGwhisk.pupamp),log10(EMGwhisk.EMGsm),...
    'minXY',500,'Xbounds',[-pi pi],'Ybounds',[-2.25 0.25],...
...
for pp= 1:2
    ...
    EMGdur.(HILO{pp})  = ConditionalHist(...
        ...
        'Ybounds',[-1.25 1.5],'numYbins',25,'numXbins',20,'Xbounds',[-pi pi],...
        'minX',10);
...
EMGdur.pup  = ConditionalHist( log10(EMGwhisk.whisks.pup),...
        ...
        'numXbins',20,'Xbounds',[-0.25 0.25],'Ybounds',[-1.25 1.5],'numYbins',25,...
        'minX',10);
