...
baseGroup = ['/gpfs/data/rudylab/William/180208_KO_EM1M3';...
    '/gpfs/data/rudylab/William/180210_KO_EM1M3';...
    '/gpfs/data/rudylab/William/180212_KO_EM1M3';...
    '/gpfs/data/rudylab/William/180525_KO_EM1M3';...
    '/gpfs/data/rudylab/William/180530_KO_EM1M3';...
...
for i = 1:size(baseGroup,1)
    ...
    %     pupsorts.Pupwhdiffval = cat(1,pupsorts.Pupwhdiffval,PSSBehavior.pupsorts.Pupwhdiffval);
    %     pupsorts.dPval = cat(1,pupsorts.dPval,PSSBehavior.pupsorts.dPval);
    %     pupsorts.durval = cat(1,pupsorts.durval,PSSBehavior.pupsorts.durval);
    %     pupsorts.peakval = cat(2,pupsorts.peakval,PSSBehavior.pupsorts.peakval);
    ...
    %     whisksorts.phaseval = cat(1,whisksorts.phaseval,PSSBehavior.whisksorts.phaseval);
    %     whisksorts.durval = cat(1,whisksorts.durval,PSSBehavior.whisksorts.durval);
    %
    %     PSSBehavior = rmfield(PSSBehavior,{'timelockedPSS','whisksorts','pupsorts','puplockedPSS'});
...
%save(savefile,'groupLFPSpectral','groupDepth');
